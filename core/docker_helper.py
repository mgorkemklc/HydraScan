...
# stream_callback parametresi eklendi
def run_command_in_docker(command, output_file_path, image_name="pentest-araci-kali:v1.5", extra_docker_args=None, stream_callback=None):
    ...
    - stream_callback: Canlı terminal çıktısı için fonksiyon.
    ...
    try:
        # Popen ile canlı okuma başlatıyoruz
        ...
        while True:
            ...
            if line:
                ...
                if stream_callback: stream_callback(line) # GUI'ye gönder
...
# Build fonksiyonu (Aynen kalıyor)
